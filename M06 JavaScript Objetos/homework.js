...
function invocarMetodo(objeto, metodo) {
   // El parámetro "metodo" es un string que coincide con
   // el nombre de una propiedad del objeto recibido.
...
function verificarPassword(objetoUsuario, password) {
   // Verifica si la propiedad "password" del "objetoUsuario"
   // coincide con el parámetro "password".
   // En ese caso retornar True. Caso contrario, False.
   // Tu código:
...
function actualizarPassword(objetoUsuario, nuevaPassword) {
   // Reemplaza la contrseña guardada en la propiedad "password" 
   //del "objetoUsuario".
